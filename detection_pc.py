...
# Configuration
CLIENT_PC_IP = "192.168.1.101"  # CHANGE THIS to your Client PC's IP
TCP_PORT = 6000
UDP_PORT = 6001
...
def create_gradio_interface(processor: NetworkedAIProcessor):
    ...
    def start_system(client_ip, model_path, device, cpu_threads):
    ...
    with gr.Blocks(title="Performance Analysis - Analysis PC") as interface:
        ...
        start_btn.click(
            fn=start_system,
            inputs=[client_ip, model_path, device, cpu_threads],
            outputs=None
        )
